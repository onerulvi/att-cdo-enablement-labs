...
4. Once you access your project, select the **Assets** tab in the project overview screen and click the blue **New asset** icon.
...
7. Leave all the settings as-is, and press the blue **Create** button. Wait a few moments for the import process to complete.
...
<details open id="71-triggering-the-alert">
...
<details id="8-summary">
<summary><h2>8. Summary</h2></summary>
...
- **Real-time monitoring** - View pipeline execution and performance as jobs run
- **Historical trends** - Track job performance and data interactions over time
- **Proactive alerting** - Get notified immediately when issues occur
- **Schema change detection** - Automatically detect and alert on schema changes
- **Integration visibility** - See the complete flow of data through your pipelines
